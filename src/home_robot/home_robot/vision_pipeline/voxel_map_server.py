...
class ImageProcessor:
    ...
    def sample_navigation(self, point, radis_m = 0.8, verbose = True, max_tries = 100):
    ...
    def process_rgbd_images(self, data):
        ...
        self.voxel_map.add(camera_pose = pose, rbg = rgb, depth = depth, camera_K = intrinsics)
