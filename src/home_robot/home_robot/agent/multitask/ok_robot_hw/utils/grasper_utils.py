...
from home_robot.agent.multitask.ok_robot_hw.image_publisher import ImagePublisher
from home_robot.agent.multitask.ok_robot_hw.global_parameters import *
from home_robot.agent.multitask.ok_robot_hw.utils.utils import apply_se3_transform
...
def pickup(robot, rotation, translation, base_node, gripper_node, gripper_height = 0.03, gripper_depth=0.03, gripper_width = 1):
    ...
    if diff > 0.08:
        ...
        # time.sleep(2)
        # base2gripper_transform, _, _, _ = robot.get_joint_transform('base_link', gripper_node)
